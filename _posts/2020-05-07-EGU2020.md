...
# G3.2: quick numbers
Session G3.2 included **31** displays, from which XX uploaded presentation materials. <br>
...
**Change** breaks into top 5 if we count change and changes as one world. <br>
Insightful, isn't it?


But what about a visual? This is what we get if we translate the frequency numbers into a **wordcloud** visual representation:

<img src="../images/egu2020_g32_wordcloud.jpg"  height="400" title="EGU2020 session G3.2 worldcloud"/>

Awesome! I posted the worldcloud on Twitter in real-time during the meeting. EGU_Geodesy draw a nice summary statement:
...
This short blog was derived from the jupyther notebook hosted on github [here]().

Indeed, an inspiring and fun evening. **Open sciene is awesome!**. 
